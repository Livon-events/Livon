...
export default function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-[1000] flex h-16 items-center justify-around border-t-[3.5px] border-[#FFF335] bg-[#0C0C0C] px-6 pt-1.5"
    ...
    >
      ...
      <Link href="/create-event" className="flex items-center justify-center">
        <div className="flex h-11 w-11 items-center justify-center rounded-full bg-[#FFF335] transition-transform hover:scale-105 active:scale-90">
