        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="h-12 bg-[#1F2023] border-2 border-[#1F2023] rounded-xl px-3.5 text-white text-[15px] outline-none focus:border-[#FFF335]"
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="resize-none bg-[#1F2023] border-2 border-[#1F2023] rounded-xl px-3.5 py-3 text-white text-[15px] outline-none placeholder:text-[#8e8e8e] focus:border-[#FFF335]"
            />
