    ...
    <section className="mt-6 rounded-lg border border-[#3A3A3C] bg-[#161616] p-4 sm:mt-8 sm:p-5">
      ...
      {!isSignedIn && (
        <>
          ...
          <Link
            href={loginHref}
            className="mt-4 inline-flex min-h-[44px] items-center justify-center rounded-md bg-[#FFF335] px-4 text-sm font-extrabold text-[#0C0C0C] transition-transform active:scale-[0.98]"
          >
      ...
      {isSignedIn && canViewerClaim && confirming && (
        <div className="mt-3 rounded-md border border-[#3A3A3C] bg-[#0C0C0C]/40 p-3">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex min-h-[44px] items-center justify-center rounded-md bg-[#FFF335] px-4 text-sm font-extrabold text-[#0C0C0C] disabled:opacity-60"
            >
